...
class DetectionScreenBak extends StatefulWidget {
  const DetectionScreenBak({super.key});

  @override
  State<DetectionScreenBak> createState() => _DetectionScreenBakState();
}

class _DetectionScreenBakState extends State<DetectionScreenBak> {
//TODO declare variables
  ...
  _imgFromGallery() async {
    ...
    for(int index = 1; index < 13; index++) {
      try {
        final byteData = await rootBundle.load('images/sources/source_$index.jpg');
        final file = File('${(await getTemporaryDirectory()).path}/images/sources/source_$index.jpg');
        await file.create(recursive: true);
